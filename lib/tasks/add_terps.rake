...
namespace :db do
  ...
  task :add_terps => :environment do
    terps = [
      { name: "t1a", email: "t1a@test.com", password: 'Password1', roles: [:interpreter], skill_level: 'M', hourly_rate: '5000' },
      { name: "t1b", email: "t1b@test.com", password: 'Password1', roles: [:interpreter], skill_level: 'H', hourly_rate: '9000' },
      { name: "t2a", email: "t2a@test.com", password: 'Password1', roles: [:interpreter], skill_level: 'L', hourly_rate: '1000' },
      { name: "t2b", email: "t2b@test.com", password: 'Password1', roles: [:interpreter], skill_level: 'M', hourly_rate: '4500' }
    ]
